...
Minecraft honeypot trap that emulates the Minecraft Java Edition server protocol to capture connection attempts, server list pings, and login attempts from attackers scanning for exposed game servers.
