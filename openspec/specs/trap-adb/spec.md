...
ADB (Android Debug Bridge) honeypot trap that emulates the ADB protocol to capture connection attempts and system identity strings from attackers scanning for exposed ADB services.
