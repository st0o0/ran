...
Consistent structured logging conventions ensuring all session events use uniform field names, static messages, and bounded action values for reliable Loki querying.
