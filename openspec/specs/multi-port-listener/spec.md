...
Multi-port TCP listener abstraction allowing a single trap to accept connections on multiple addresses/ports simultaneously, with HTTP ConnContext support for dest_port derivation.
